...
const GuestCompilerQuestion: React.FC<GuestCompilerQuestionProps> = ({ isModal, onSuccess, onCancel }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const newQuestionId = isEditMode ? undefined : 0; // Wait, API doesn't return question_id on guest create? I'll check it, but let's assume not. We can just call onSuccess.
  ...
  return (
    <div className="w-full max-w-7xl mx-auto overflow-x-hidden pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        <button
          onClick={() => isModal && onCancel ? onCancel() : navigate("/guest-compiler-questions")}
