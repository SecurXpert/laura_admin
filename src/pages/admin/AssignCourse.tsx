...
const AssignCourse = () => {
  ...
  // Group the filtered data by instructor to show multiple course pills per row
  const groupedInstructors = Object.values(
    filteredData.reduce((acc, curr) => {
      if (!acc[curr.instructor_id]) {
      ...
      if (!acc[curr.instructor_id].courses.find((c: any) => c.id === curr.course_id)) {
        acc[curr.instructor_id].courses.push({
          id: curr.course_id,
  ...
  <Button
    size="sm"
    onClick={() => navigate("/dashboard/assign-instructor")}
