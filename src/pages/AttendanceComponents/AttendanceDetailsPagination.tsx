...
interface AttendanceDetailsPaginationProps {
  currentPage: number;
...
export const AttendanceDetailsPagination: React.FC<
  AttendanceDetailsPaginationProps
> = ({ currentPage, totalFiltered, itemsPerPage, onPageChange }) => {
