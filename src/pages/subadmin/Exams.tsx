...
const Exams = () => {
  ...
  const handleDelete = async (examId: number) => {
    ...
    try {
      await api.delete(`/exam/delete?exam_id=${examId}`);
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div>
              ...
              <p className="text-md sm:text-md text-[#4B5563] mt-1 font-medium">
                Manage and configure examination sessions
              </p>
            </div>
                      ...
                      return (
                        <tr key={exam.id} className="hover:bg-gray-50/50 transition-colors">
                          ...
                          <td className="p-4 text-gray-600 font-medium">
                            {courses.find(c => c.id === exam.course_id)?.title || `Course ID: ${exam.course_id}`}
                          </td>
                          <td className="p-4">
                          ...
                          <td className="p-4 pr-6">
                            <div className="flex items-center justify-center gap-3">
                              <button onClick={() => navigate(formatNav(`/dashboard/exams/view/${exam.id}`))} className="text-indigo-500 hover:text-indigo-700 transition" title="View"><FiEye className="w-4 h-4" /></button>
