...
const StudentEdit = () => {
  ...
  const getToken = () => localStorage.getItem(TOKEN_STORAGE_KEY) || localStorage.getItem('token');
  const axiosConfig = () => ({
    headers: {
    ...
    <div className="space-y-6 max-w-[1200px] mx-auto pb-12">
      ...
      <div className="flex flex-wrap gap-2 mt-6">
        <button
          ...
          className={`px-5 py-2.5 text-sm font-semibold rounded-xl transition-all ${activeTab === 'security'
        ...
        <button
          ...
          className={`px-5 py-2.5 text-sm font-semibold rounded-xl transition-all ${activeTab === 'basic'
              ? 'bg-blue-50 text-blue-700 shadow-sm border border-blue-100'
              : 'bg-white text-gray-500 hover:bg-gray-50 border border-gray-200'
            }`}
        >
