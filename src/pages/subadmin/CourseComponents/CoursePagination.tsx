...
const CoursePagination: React.FC<CoursePaginationProps> = ({
  ...
  if (loading || totalFiltered === 0) return null;
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between py-5 mt-4 border-t border-gray-100 gap-6 w-full">
      <div className="text-[13px] font-medium text-[#6B7280]">
        Showing {totalFiltered > 0 ? (currentPage - 1) * itemsPerPage + 1 : 0}-{Math.min(currentPage * itemsPerPage, totalFiltered)} of {totalFiltered}
      </div>
