        ...
        <div className="w-full min-w-0">
          ...
          <select
            ...
            className={`w-full h-11 sm:h-12 px-3 sm:px-4 rounded-xl border ${errors.category_id ? "border-red-500 bg-red-50/30" : "border-gray-200"
              } text-xs sm:text-sm outline-none focus:ring-2 focus:ring-[#5D3EFC]/20 focus:border-[#5D3EFC] ${isEdit ? "bg-gray-100 cursor-not-allowed opacity-80 select-none" : "bg-white"} transition-all shadow-sm truncate`}
          >
