...
export type GuestCompilerQuestionType = {
  question_id: number;
  title: string;
  question: string;
  description: string;
...
const GuestCompilerQuestions = () => {
  const [questions, setQuestions] = useState<GuestCompilerQuestionType[]>([]);
      ...
      <>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full md:w-auto">
            <button
              onClick={() => navigate(formatNav("/dashboard/guest-compiler-questions/add"))}
                    ...
                    <tr key={q.question_id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="p-4 pr-6">
                        <div className="flex items-center justify-center gap-3">
                          <button onClick={() => navigate(formatNav(`/dashboard/guest-compiler-questions/view/${q.question_id}`))} className="text-indigo-500 hover:text-indigo-700 transition" title="View">
                            <FiEye className="w-4 h-4" />
                          </button>
                          <button onClick={() => navigate(formatNav(`/dashboard/guest-compiler-questions/edit/${q.question_id}`))} className="text-orange-500 hover:text-orange-700 transition" title="Edit">
