...
interface AttachGuestQuestionsModalProps {
  exam: GuestExam;
  onClose: () => void;
  onSuccess: () => void;
}

const AttachGuestQuestionsModal: React.FC<AttachGuestQuestionsModalProps> = ({ exam, onClose, onSuccess }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.put(`/guest/exam/update?exam_id=${exam.id}`, payload);
      toast({
        title: "Attached",
        description: "Guest exam questions updated successfully",
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
      <div className="bg-white w-full max-w-2xl rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
          <div>
            <h2 className="text-xl font-bold text-gray-800">Attach Guest Questions</h2>
...
export default AttachGuestQuestionsModal;
